...
function App() {
  ...
  return (
    <React.Fragment>
      ...
      {page === 'sms-inbox'        && <SMSInboxPage {...props}/>}
      {page === 'calls'            && <CallsPage {...props}/>}
      ...
      {page === 'settings-notifications'&& <SettingsNotificationsPage {...props}/>}
      {page === 'settings-unsubscribes' && <SettingsUnsubscribesPage {...props}/>}
      {page === 'settings-privacy'      && <SettingsPrivacyPage {...props}/>}
